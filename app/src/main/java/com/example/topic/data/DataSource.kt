...
object DataSource {
    val topics = listOf(
        ...
        Topic(R.string.biology, 124, R.drawable.biology),
        ...
        Topic(R.string.finance, 101, R.drawable.finance),
        Topic(R.string.gaming, 164, R.drawable.gaming),
        Topic(R.string.geology, 30, R.drawable.geology),
        Topic(R.string.history, 100, R.drawable.history),
